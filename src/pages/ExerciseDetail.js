...
([]);
  ...
  useEffect(() => {
    const fetchExercisesData = async () =>{
        ...
        const targeEquipmentData = await fetchData(`${exerciseDbUrl}/exercises/equipment/${exerciseDetailData.equipment}`,exerciseOptions);
        setTargetEquipment(targeEquipmentData);
  ...
  return (
    <Box>
       ...
       <Suggestions targetMuscle={targetMuscle} targetEquipment={targetEquipment}/>
    </Box>
  )
}
